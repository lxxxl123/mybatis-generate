 ...
 */
@Slf4j
public class GeneratorFrontEndTwoPage extends Generator {

    public void execute() {
        buildConfig("gen-front-two-page.yaml");
        // 获取数据库信息
    ...
    public static void main(String[] args) throws MojoExecutionException, MojoFailureException {
        GeneratorFrontEndTwoPage generatorVue = new GeneratorFrontEndTwoPage();
